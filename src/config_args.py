...
def get_args(parser):
    ...
    parser.add_argument('-encoder', type=str, choices=['rnn', 'graph', 'emb', 'mlp', 'resnet'], default='resnet')
    parser.add_argument('-decoder', type=str, choices=['sa_m', 'rnn_m', 'sa_b', 'graph', 'mlp'], default='graph')
